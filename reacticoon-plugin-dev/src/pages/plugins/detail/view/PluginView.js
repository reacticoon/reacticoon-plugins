...
import { generateRoutes } from 'reacticoon/routing/config'
              ...
              <div className={classes.right}>
                <div>
                  {pluginData.identity.hasLogo ? (
                    ...
                    <img className={classes.logo} src={pluginData.identity.logoUrl} />
                  )}
                </div>
              </div>
            </div>
          ...
          {pluginData.identity.isReacticoonPlugin && (
            <React.Fragment>
              ...
              <Section title="Routing">
                <RoutingView routing={generateRoutes(pluginData.plugin.routing)} />
              </Section>
              ...
              <Section title="Events handler">
                <EventsHandlerView eventsHandler={pluginData.plugin.eventsHandler} />
              </Section>
            </React.Fragment>
          )}
          ...
          {pluginData.identity.isReacticoonCliPlugin && (
            <React.Fragment>
              <Section title="Commands">
                <CliCommands commands={pluginData.identity.cliPluginData.commands} />
              </Section>

              <Section title="Server commands">
                <CliServerCommands
                  serverCommands={pluginData.identity.cliPluginData.serverCommands}
                />
              </Section>

              <Section title="Overrides">
                <CliOverrides overridesData={pluginData.identity.cliPluginData.overridesData} />
              </Section>

              <Section title="Checkup">
                <CliCheckup checkup={pluginData.identity.cliPluginData.checkup} />
              </Section>

              <Section title="Generators">
                <CliGenerators generators={pluginData.identity.cliPluginData.generators} />
              </Section>
            </React.Fragment>
          )}
        </Section.Container>
