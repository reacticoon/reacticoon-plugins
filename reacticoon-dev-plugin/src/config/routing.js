...
const routingEnum = createRoutingEnum({
  ...
  REACTICOON_PLUGINS: new Route(
    "REACTICOON::PLUGINS",
    `${ROUTE_PREFIX}/plugins`
  ),
  REACTICOON_PLUGIN: new Route(
    "REACTICOON::PLUGIN",
    `${ROUTE_PREFIX}/plugins/:pluginName`
  ),
  REACTICOON_ROUTING: new Route(
    "REACTICOON::ROUTING",
    `${ROUTE_PREFIX}/routing`
  ),
  REACTICOON_REPORTS: new Route(
    "REACTICOON::REPORTS",
    `${ROUTE_PREFIX}/reports`
  ),
  REACTICOON_MY_APP: new Route("REACTICOON::MY_APP", `${ROUTE_PREFIX}/app`),
  REACTICOON_MODULE: new Route(
    "REACTICOON::MODULE",
    `${ROUTE_PREFIX}/modules/:moduleName`
  ),
  REACTICOON_REPORT_CHECKUP: new Route(
    "REACTICOON::CHECKUP",
    `${ROUTE_PREFIX}/reports/checkup`
  ),
...
const routes = [
  {
    ...
    handler: createAsyncPage(() =>
      import(
        /*  webpackChunkName: "Reacticoon__DashboardPage" */ "../pages/dashboard"
      )
    )
  },
  {
    ...
    handler: createAsyncPage(() =>
      import(
        /*  webpackChunkName: "Reacticoon__PluginPage" */ "../pages/plugin"
      )
    )
  },
  {
    ...
    handler: createAsyncPage(() =>
      import(
        /*  webpackChunkName: "Reacticoon__PluginsPage" */ "../pages/plugins"
      )
    )
  },
  {
    ...
    handler: createAsyncPage(() =>
      import(
        /*  webpackChunkName: "Reacticoon__RoutingPage" */ "../pages/routing"
      )
    )
  },
  {
    ...
    handler: createAsyncPage(() =>
      import(
        /*  webpackChunkName: "Reacticoon__ReportsPage" */ "../pages/reports"
      )
    )
  },
  {
  ...
  },
  {
    ...
    handler: createAsyncPage(() =>
      import(
        /*  webpackChunkName: "Reacticoon__ModulePage" */ "../pages/module"
      )
    )
  },
  {
    ...
    handler: createAsyncPage(() =>
      import(
        /*  webpackChunkName: "Reacticoon__ReportCheckupPage" */ "../pages/checkup"
      )
    )
  },
  {
    ...
    handler: createAsyncPage(() =>
      import(
        /*  webpackChunkName: "Reacticoon__ReportPluginsPage" */ "../pages/cli-plugins"
      )
    )
  },
  {
    ...
    handler: createAsyncPage(() =>
      import(
        /*  webpackChunkName: "Reacticoon__ReportAnalyzeBuildPage" */ "../pages/analyze-build"
      )
    )
  },
  {
